...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'taxonomy-moves' ); ?>>
    ...
    <div class="move-basics">
        ...
        <span class="adds"><?php the_field('adds'); ?></span>
    </div>
    ...
    <div class="move-details">
        ...
        <?php
            ...
            {
                echo '<p class="description"><strong>Description:</strong> ' . get_field('description') . '</p>';
            }
